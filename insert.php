            ...
            <form action="process.php" method="POST" autocomplete="off">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" placeholder="Enter Student ID" class="form-control" name="student_id">
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" placeholder="Enter First Name" class="form-control" name="mname">
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="lname" class="form-label">Last Name</label>
                        <input type="text" placeholder="Enter First Name" class="form-control" name="lname">
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="birthday" class="form-label">Date of Birth</label>
                        <input type="date" placeholder="Enter First Name" class="form-control" name="birthday">
                    </div>
